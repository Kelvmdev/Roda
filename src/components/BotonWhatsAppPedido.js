...
// guardó en sessionStorage. Si no hay enlace (entraste a /gracias directo), no
// se muestra nada.
export default function BotonWhatsAppPedido() {
  ...
  return (
    <a
      ...
      aria-label="Enviar el pedido por WhatsApp (se abre en una pestaña nueva)"
      className="inline-flex items-center gap-2 rounded-full bg-whatsapp px-8 py-3.5 font-semibold text-superficie transition duration-150 hover:bg-whatsapp-deep active:scale-95"
    >
      {/* Ícono de WhatsApp, decorativo (§5.11). */}
